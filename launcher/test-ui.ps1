...
& $compiler /nologo /target:exe /main:WindowState /out:$testExe /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:System.Web.Extensions.dll /r:System.IO.Compression.dll /r:System.IO.Compression.FileSystem.dll (Join-Path $PSScriptRoot 'Core.cs') (Join-Path $PSScriptRoot 'Program.cs') (Join-Path $PSScriptRoot 'tests/WindowState.cs')
