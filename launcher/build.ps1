...
& $compiler /nologo /target:winexe /platform:anycpu /optimize+ $defines /out:"$output\Interlude Launcher.exe" /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:System.Web.Extensions.dll /r:System.IO.Compression.dll /r:System.IO.Compression.FileSystem.dll (Join-Path $PSScriptRoot "Core.cs") (Join-Path $PSScriptRoot "Program.cs")
